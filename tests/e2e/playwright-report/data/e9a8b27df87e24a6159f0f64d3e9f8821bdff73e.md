...
- Name: comparison.spec.ts >> Feature 2: Project Comparison View >> Tier 2: Clicking compare button on a card reveals comparison bar
- Location: comparison.spec.ts:31:7

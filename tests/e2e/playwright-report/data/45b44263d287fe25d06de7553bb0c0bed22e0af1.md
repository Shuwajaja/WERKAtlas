...
- Name: comparison.spec.ts >> Feature 2: Project Comparison View >> Tier 4: Comparison link sharing persists state perfectly
- Location: comparison.spec.ts:142:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/WERKAtlas/?compare=n8n-io/n8n,ollama/ollama,weaviate/weaviate
Call log:
  - navigating to "http://localhost:4321/WERKAtlas/?compare=n8n-io/n8n,ollama/ollama,weaviate/weaviate", waiting until "load"

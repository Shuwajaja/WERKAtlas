...
- Name: pages.spec.ts >> Feature 3: Categories & Project Detail Pages >> Tier 4: Navigating to non-existent project slug shows friendly 404 page
- Location: pages.spec.ts:107:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/WERKAtlas/project/non-existent-slug/
Call log:
  - navigating to "http://localhost:4321/WERKAtlas/project/non-existent-slug/", waiting until "load"

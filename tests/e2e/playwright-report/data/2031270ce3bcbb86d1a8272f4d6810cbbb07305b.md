...
- Name: brand.spec.ts >> Feature 4: WERK Branding & CSS Design Tokens >> Tier 2: Main theme color uses Cool Graphite custom property or hex values
- Location: brand.spec.ts:42:7

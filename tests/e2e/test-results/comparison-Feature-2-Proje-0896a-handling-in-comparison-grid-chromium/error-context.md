...
- Name: comparison.spec.ts >> Feature 2: Project Comparison View >> Tier 4: Missing property handling in comparison grid
- Location: comparison.spec.ts:131:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/WERKAtlas/?compare=n8n-io/n8n,some-obscure-project
Call log:
  - navigating to "http://localhost:4321/WERKAtlas/?compare=n8n-io/n8n,some-obscure-project", waiting until "load"

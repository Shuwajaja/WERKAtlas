...
- Name: brand.spec.ts >> Feature 4: WERK Branding & CSS Design Tokens >> Tier 4: Responsive typography - titles scale gracefully on mobile screens
- Location: brand.spec.ts:106:7

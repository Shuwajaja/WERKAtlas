...
- Name: comparison.spec.ts >> Feature 2: Project Comparison View >> Tier 2: Comparison table columns map to selected projects
- Location: comparison.spec.ts:65:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/WERKAtlas/?compare=n8n-io/n8n,ollama/ollama
Call log:
  - navigating to "http://localhost:4321/WERKAtlas/?compare=n8n-io/n8n,ollama/ollama", waiting until "load"

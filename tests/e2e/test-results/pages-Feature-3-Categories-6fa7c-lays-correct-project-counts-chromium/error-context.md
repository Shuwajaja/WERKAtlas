...
- Name: pages.spec.ts >> Feature 3: Categories & Project Detail Pages >> Tier 2: Category page displays correct project counts
- Location: pages.spec.ts:43:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/WERKAtlas/category/mcp-ecosystem/
Call log:
  - navigating to "http://localhost:4321/WERKAtlas/category/mcp-ecosystem/", waiting until "load"

...
- Name: comparison.spec.ts >> Feature 2: Project Comparison View >> Tier 1: Compare view page elements should exist
- Location: comparison.spec.ts:21:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/WERKAtlas/?compare=n8n-io/n8n
Call log:
  - navigating to "http://localhost:4321/WERKAtlas/?compare=n8n-io/n8n", waiting until "load"

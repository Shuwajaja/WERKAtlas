...
- Name: pages.spec.ts >> Feature 3: Categories & Project Detail Pages >> Tier 4: Page handles projects with missing license gracefully without crash
- Location: pages.spec.ts:115:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/WERKAtlas/project/missing-metadata-project-slug/
Call log:
  - navigating to "http://localhost:4321/WERKAtlas/project/missing-metadata-project-slug/", waiting until "load"

...
- Name: brand.spec.ts >> Feature 4: WERK Branding & CSS Design Tokens >> Tier 4: Focus outline styling is visible on keyboard navigation focus
- Location: brand.spec.ts:127:7
